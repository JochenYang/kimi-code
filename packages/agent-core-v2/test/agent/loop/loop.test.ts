...
describe('Agent loop', () => {
  ...
  it('runs a text-only agent turn from prompt to completion', async () => {
    ...
    expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
      ...
      [wire] token_counting.measured     { "agentId": "main", "length": 2, "tokens": 13, "estimated": 12, "measuredInput": 3, "time": "<time>" }
  ...
  it('fails the turn after a filtered step completes', async () => {
    ...
    expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
      ...
      [wire] token_counting.measured     { "agentId": "main", "length": 2, "tokens": 8, "estimated": 18008, "measuredInput": 3, "time": "<time>" }
  ...
  it('runs an agent turn through registered tool approval and execution', async () => {
    ...
    expect(await ctx.untilApproval(true)).toMatchInlineSnapshot(`
      ...
      [wire] token_counting.measured         { "agentId": "main", "length": 2, "tokens": 20, "estimated": 49, "measuredInput": 4, "time": "<time>" }
  ...
  `);
    ...
    expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
      ...
      [wire] token_counting.measured             { "agentId": "main", "length": 4, "tokens": 37, "estimated": 70, "measuredInput": 25, "time": "<time>" }
