...
describe('Agent config', () => {
  ...
  it('keeps turn-start config for later steps and applies updates to the next turn', async () => {
    ...
    expect(await ctx.untilApproval(true)).toMatchInlineSnapshot(`
      ...
      [wire] token_counting.measured         { "agentId": "main", "length": 2, "tokens": 26, "estimated": 54, "measuredInput": 9, "time": "<time>" }
    ...
    expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
      ...
      [wire] token_counting.measured     { "agentId": "main", "length": 5, "tokens": 102, "estimated": 98, "measuredInput": 89, "time": "<time>" }
    ...
    expect(await ctx.untilTurnEnd()).toMatchInlineSnapshot(`
      ...
      [wire] token_counting.measured        { "agentId": "main", "length": 7, "tokens": 120, "estimated": 114, "measuredInput": 108, "time": "<time>" }
